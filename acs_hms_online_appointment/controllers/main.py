...
class HMSWebsite(Website):
    ...
    def user_booking_data(self, post):
        ...
        values.update({
            ...
            'allow_video_call': user.company_id.acs_allowed_video_consultation,
...
class AcsCustomerPortal(CustomerPortal):
    ...
    def _create_transaction(
        ...
        tokenization_requested, landing_route, is_validation=False, invoice_id=None, acs_appointment_id=None,
        custom_create_values=None, **kwargs
    ):
        res = super(AcsCustomerPortal, self)._create_transaction(payment_option_id, reference_prefix, amount, currency_id, partner_id, flow,
