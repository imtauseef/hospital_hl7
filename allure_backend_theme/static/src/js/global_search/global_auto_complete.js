odoo.define('allure_backend_theme.GlobalSearchAutoComplete', function (require) {
"use strict";
        ...
        make_list_item: function (result) {
            ...
            if (result.indent){
                if(result.label){$li.append($('<span>').html(' '+result.label));}
                    ...
                    let escapedString = this.search_string.replace(/[\\[.+*?(){|^$]/g, "\\$&");
                    let regex = RegExp(escapedString, 'gi');
                    ...
                    if(!_.isEmpty(self.selected_data)) {
                        ...
                        return self.do_action({
                            ...
                            return rpc.query({
                                ...
                                args: ['allure_backend_theme.menu_global_search']
                            }).then(function(result){
