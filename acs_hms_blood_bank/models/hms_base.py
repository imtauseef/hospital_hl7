...
class ResPartner(models.Model):
    ...
    @api.depends('acs_blood_requisition_ids','acs_blood_issuance_count')
    ...
    acs_blood_requisition_count = fields.Integer(compute="_blood_count", readonly=True, string="#Blood Donations", store=True)
    acs_blood_issuance_count = fields.Integer(compute="_blood_count", readonly=True, string="#Blood Requisitions", store=True)
