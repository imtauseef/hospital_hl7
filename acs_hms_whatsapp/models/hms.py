    ...
    def send_appointment_reminder(self):
        ...
        for appointment in reminder_appointments:
            if appointment and appointment.patient_id and appointment.patient_id.mobile and appointment.company_id.acs_appointment_reminder_template_id:
                template_id = appointment.company_id.acs_appointment_reminder_template_id
                ...
                self.send_whatsapp(msg, appointment.patient_id.mobile, appointment.patient_id.partner_id, res_model='hms.appointment', res_id=appointment.id)
    ...
    def appointment_confirm(self):
        ...
        for rec in self:
            ...
            if template and rec.patient_id and rec.patient_id.mobile:
                ...
                msg = rendered[rec.id]
                self.send_whatsapp(msg, rec.patient_id.partner_id.mobile, rec.patient_id.partner_id, res_model='hms.appointment', res_id=rec.id)
        return res
    ...
    def create(self, vals_list):
        ...
        for record in res:    
            if template and record.mobile:
                ...
                msg = rendered[res.id]
                self.send_whatsapp(msg, record.partner_id.mobile, record.partner_id, res_model='hms.patient', res_id=record.id)
        return res
