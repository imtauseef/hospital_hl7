...
class AcsHmsEmergency(models.Model):
    ...
    name = fields.Char(string='Name', readonly=True, copy=False, tracking=True, states=READONLY_STATES)
    ...
    date = fields.Datetime(string='Admission Date', default=fields.Datetime.now, states=READONLY_STATES, tracking=True, copy=False)
    ...
    diseases_ids = fields.Many2many('hms.diseases', 'diseases_emergency_rel', 'diseas_id', 'emergency_id', 'Diseases', states=READONLY_STATES)
