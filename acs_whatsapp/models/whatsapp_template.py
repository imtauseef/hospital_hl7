...
class whatsappTemplate(models.Model):
    ...
    header_message_type =  fields.Selection([
        ...
        ('DOCUMENT', 'Document'),
        ('IMAGE', 'Image')
    ], string='Header Message Type', states=READONLY_STATES)
    ...
    body_message_type =  fields.Selection([
        ...
        ('DOCUMENT', 'Document'),
        ('IMAGE', 'Image')
    ], string='Body Message Type', default='TEXT', states=READONLY_STATES, required=True)
    ...
    footer_message_type =  fields.Selection([
        ...
        ('DOCUMENT', 'Document'),
        ('IMAGE', 'Image')
    ], string='Footer Message Type', states=READONLY_STATES)
