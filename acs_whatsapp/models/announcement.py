...
class WhatsappAnnouncement(models.Model):
    ...
    def acs_create_message(self, mobile, partner=False, res_model=False, res_id=False):
    ...
    def send_message(self):
        if self.announcement_type=='contacts':
            for partner in self.partner_ids:
                if partner.mobile:
                    self.acs_create_message(partner.mobile, partner,res_model='res.partner', res_id=partner.id)
        else:
            ...
            for employee in employees:
                ...
                if mobile:
                    self.acs_create_message(mobile, False, res_model='hr.employee', res_id=employee.id)
