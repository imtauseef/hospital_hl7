...
class ResCompany(models.Model):
    ...
    def acs_update_access_data(self):
        ...
        try:
            ...
            if "acs_hms_hospitalization" in loaded_modules:
            ...
            if "acs_hms_radiology" in loaded_modules:
            ...
            if "acs_hms_commission" in loaded_modules:
            ...
            if "acs_hms_emergency" in loaded_modules:
